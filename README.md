...
We support installation using `conda` package manager. Instructions can be found [here](https://oommfc.readthedocs.io/en/latest/ipynb/00-tutorial-installation-testing-upgrade.html).
...
Documentation is available [here](https://oommfc.readthedocs.io/en/latest/), where APIs and tutorials as Jupyter notebooks are available.
